...
/**
 * Defines the SellerContactDetailsEnabled feature. If the field is present, 
 * thecategory allows retrieval of seller-level contact information. The field 
 * isreturned as an empty element (e.g., a boolean value is not returned). 
 *
