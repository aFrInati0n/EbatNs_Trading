 ...
 * dependencies on ID-based attributes now. Instead, use FindProducts in eBay's 
 ...
 * find more matchingitems, use the 
 * <ahref="http://www.developer.ebay.com/DevZone/finding/CallRef/index.html">FindingAPI</a>.)</li></ul><p><span 
 * class="tablenote"><b>Note:</b>As catalog queries can take longer than item 
 * queries.Also, due to the way product data is cached, you may get a faster 
 * responsewhen you run the same query a second time.</span> 
 *
