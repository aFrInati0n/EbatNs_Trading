 ...
 * Youcan receive the status of individual items you have reported or, by 
 * specifyingVeROReportPacketID, you can retrieve status for all items reported 
 * with a givenVeROReportItems request. You can also retrieve items that were 
 * reported during agiven time period. If no input parameters are specified, status 
 * is returned on allitems you have reported in the last two years.You must be a 
 * member of the Verified Rights Owner (VeRO) Program to use thiscall. 
 *
