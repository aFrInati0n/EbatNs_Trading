...
/**
 * A container consisting of details about the transaction against which the seller 
 * issued a refund. If an order ID is present, it indicates that the refund was 
 * issued against the entire order. If an item ID and transaction ID are present, 
 * that indicates that the refund was issued against that particular order line 
 * item. 
 *
