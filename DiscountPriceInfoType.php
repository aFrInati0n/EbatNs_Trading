...
/**
 * The original retail price, the discount price, and the associated discount 
 * pricing treatment detailsfor an item. Discount pricing treatments (Strikethrough 
 * Pricing and Minimum Advertised Price) applyto only fixed price, BIN items. 
 * sellers can apply Discount Pricing to both MSKU and Non-MSKU items. 
 *
