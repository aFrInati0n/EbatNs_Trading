...
/**
 * Use this container to supply the original retail price, the discount price, and 
 * theassociated discount pricing treatment details for an item. Discount pricing 
 * treatments(Strike-Through Pricing and Minimum Advertised Price) applies to only 
 * fixed price, BIN items.This feature is available for large enterprise/BD sellers 
 * via white list. A seller canprovide discount treatment for Non-MSKU and MSKU 
 * items. 
 *
