 ...
 * the amount refunded for an order line item to a single buyer. <br/><br/><span 
 * class="tablenote"><strong>Note:</strong> Three RefundType fields 
 * (RefundFromSeller, RefundTime and TotalRefundToBuyer) are returned (for 
 * GetOrders) only if a refund has been issued against a Half.com 
 * transaction.</span> 
 *
