 ...
 * @property string FeeGlobalShipping
 * @property string CreditGlobalShipping
 */
class AccountDetailEntryCodeType extends EbatNs_FacetType
{
	...
	const CodeType_FeeGlobalShipping = 'FeeGlobalShipping';
	const CodeType_CreditGlobalShipping = 'CreditGlobalShipping';
