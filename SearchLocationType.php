 ...
 * GetCategoryListings. Allows filtering based on thelocation of the item or its 
 * availability relative to an eBay site. Or allowsfor filtering based on regional 
 * listing. 
 *
