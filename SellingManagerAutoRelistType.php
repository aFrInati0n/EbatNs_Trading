...
/**
 * Provides information about an automated relisting rule.Automated relisting rules 
 * cannot be combined with automated listing rules.A template can have one set of 
 * information per automated relisting rule specified. 
 *
