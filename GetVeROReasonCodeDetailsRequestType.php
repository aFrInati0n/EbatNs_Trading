 ...
 * areason code ID to get details for a specific reason on the site specified in 
 * therequest header. If ReasonCodeID is not passed in the request, all reason 
 * codes arereturned. Set ReturnAllSites to true to retrieve reason codes for all 
