...
/**
 * This type provides information about one order line item in a Global Exchange 
 * package. The package can contain multiple units of a given order line item. 
 * <br/><br/><span class="tablenote"><strong>Note:</strong> The Global Exchange 
 * program is available for testing with simulated responses in the Sandbox in 
 * mid-June 2012. The full functionality of the Global Exchange program will be 
 * available in August 2012.</span> 
 *
