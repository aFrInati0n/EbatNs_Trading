 ...
 * corresponding feature applies to the site. The field is returned asan empty 
 * element (e.g., a boolean value is not returned).<br><br>Multi-variation listings 
 * contain items that are logically the sameproduct, but that vary in their 
 * manufacturing details or packaging.For example, a particular brand and style of 
 * shirt could beavailable in different sizes and colors, such as "large blue" 
 * and"medium black" variations. 
 *
