...
/**
 * <b>Half.com only.</b>&nbsp;Issues a refund for a single Half.com transaction. 
 * This can only be called by a seller. A refund may only be issued for a 
 * specifictransaction. Sellers do not have the ability to issue a generalrefund (a 
