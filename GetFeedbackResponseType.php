...
/**
 * The GetFeedback response contains the feedback summary if aTransaction ID or 
 ...
 * feedback score and feedback summary for the requestinguser will be 
 * returned.<br>If a detail level value of ReturnAll is specified, an array of all 
 * feedbackrecords will be returned. 
 *
