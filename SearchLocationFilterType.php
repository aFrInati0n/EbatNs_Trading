 ...
 * GetSearchResults.Allows filtering based on an item's location (where the seller 
 * would be shippingthe item from) or an item's availability (which eBay sites the 
 * item can bepurchased from). 
 *
