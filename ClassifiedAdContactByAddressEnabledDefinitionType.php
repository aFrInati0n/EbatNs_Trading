...
/**
 * Indicates whether the category supports the use of an address whencontacting the 
 * seller for Classified Ad format listings.Added for the For Sale By Owner format. 
 *
