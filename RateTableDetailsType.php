 ...
 * shipping rates offered for an item based on the shipping destination. They can 
 * specify a base rate for a country, then define alternative rates or surcharges 
 * for shipping to more distant or inconvenient (extended) regions within the 
 * country. <br><br>Prerequisites for applying shipping rate tables:<ul><li>The 
 * item must be listed on the eBay DE, UK, or US site. </li><li>The shipping type 
 * for the listing must be Flat. </li><li>The seller must have previously 
