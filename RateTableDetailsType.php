...
/**
 * Details pertinent APIs to allow sellers who have already set-up a shipping rate 
 * table tohave the option to use their Domestic Rate Table with their Flat service 
